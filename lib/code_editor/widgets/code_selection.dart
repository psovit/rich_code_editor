...
class TextSelectionOverlay {
  ...
  final ce.RenderEditableCode renderObject;
  ...
  Widget _buildToolbar(BuildContext context) {
    ...
    final List<ce.TextSelectionPoint> endpoints =
...
class _TextSelectionHandleOverlayState
  ...
  Widget build(BuildContext context) {
    final List<ce.TextSelectionPoint> endpoints = widget.renderObject.getEndpointsForSelection(widget.selection);
    Offset point;
  ...
  TextSelectionHandleType _chooseType(
    ce.TextSelectionPoint endpoint,
