...
class MaterialTextSelectionControls extends cs.TextSelectionControls {
  ...
  Widget buildToolbar(
    ...
    Offset position,
    List<ce.TextSelectionPoint> endpoints,
  ...
  @override
  Widget buildHandle(
      BuildContext context, cs.TextSelectionHandleType type, double textHeight) {
    ...
    switch (type) {
      case cs.TextSelectionHandleType.left: // points up-right
        return Transform.rotate(
          angle: math.pi / 2.0,
          child: handle,
        );
      case cs.TextSelectionHandleType.right: // points up-left
        return handle;
      case cs.TextSelectionHandleType.collapsed: // points up
        return Transform.rotate(
          angle: math.pi / 4.0,
          child: handle,
        );
  ...
  @override
  Offset getHandleAnchor(cs.TextSelectionHandleType type, double textLineHeight) {
    switch (type) {
      case cs.TextSelectionHandleType.left:
        return const Offset(_kHandleSize, 0);
      case cs.TextSelectionHandleType.right:
        return Offset.zero;
      default:
