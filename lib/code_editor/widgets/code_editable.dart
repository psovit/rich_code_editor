...
///
/// Used by [RenderEditableCode.onCaretChanged].
typedef CaretChangedHandler = void Function(Rect caretRect);

/// Represents the coordinates of the point in a selection, and the text
/// direction at that point, relative to top left of the [RenderEditableCode] that
/// holds the selection.
@immutable
...
class RenderEditableCode extends RenderBox {
